...
public class OI {
    ...
    public OI() {
        ...
        x.whileHeld(new auto_claw_hold());
        b = new JoystickButton(joystick1, 2);
        b.whileHeld(new auto_claw_middle());
        y = new JoystickButton(joystick1, 4);
        y.whileHeld(new auto_claw_far());
        a = new JoystickButton(joystick1, 1);
        a.whileHeld(new auto_claw_close());
        joystick0 = new Joystick(0);
        
        dx = new JoystickButton(joystick0, 3);
        dx.whileHeld(new joystick_drive_lock());
        ...
        SmartDashboard.putData("readDistanceEncoders", new readDistanceEncoders());
        SmartDashboard.putData("zeroDistanceEncoders", new zeroDistanceEncoders());
        SmartDashboard.putData("zDriveToDistance", new zDriveToDistance(12));
