...
public class Robot extends TimedRobot {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        //UsbCamera camera = CameraServer.getInstance().startAutomaticCapture("FrontViewRaw", 1);
        //UsbCamera camera2 = CameraServer.getInstance().startAutomaticCapture("FrontViewRaw2", 0);
