...
public class Robot extends TimedRobot {
    ...
    public static DistanceSubsystem distanceSubsystem;
    ...
    public void robotInit() {
        ...
        distanceSubsystem = new DistanceSubsystem();
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
        ...
        new Thread(() -> {
            ...
            CvSource outputStream = CameraServer.getInstance().putVideo("FrontView", 640, 480);
