...
public class RobotMap {
    ...
    public static Encoder driveSystemBackLeftDistanceEncoder;
    public static Encoder driveSystemBackRightDistanceEncoder;
    public static Encoder driveSystemFrontLeftDistanceEncoder;
    public static Encoder driveSystemFrontRightDistanceEncoder;
...
//    public static PWInput leftSideAftSonar;
    ...
    public static void init() {
        ...
        driveSystemBackLeftDistanceEncoder = new Encoder(6, 7, false, EncodingType.k4X);
        LiveWindow.addSensor("DriveSystem", "BackLeftDistanceEncoder", driveSystemBackLeftDistanceEncoder);
        driveSystemBackLeftDistanceEncoder.setDistancePerPulse(1.0);
        driveSystemBackLeftDistanceEncoder.setPIDSourceType(PIDSourceType.kDisplacement);
        driveSystemBackRightDistanceEncoder = new Encoder(8, 9, false, EncodingType.k4X);
        LiveWindow.addSensor("DriveSystem", "BackRightDistanceEncoder", driveSystemBackRightDistanceEncoder);
        driveSystemBackRightDistanceEncoder.setDistancePerPulse(1.0);
        driveSystemBackRightDistanceEncoder.setPIDSourceType(PIDSourceType.kDisplacement);
        driveSystemFrontLeftDistanceEncoder = new Encoder(4, 5, false, EncodingType.k4X);
        LiveWindow.addSensor("DriveSystem", "FrontLeftDistanceEncoder", driveSystemFrontLeftDistanceEncoder);
        driveSystemFrontLeftDistanceEncoder.setDistancePerPulse(1.0);
        driveSystemFrontLeftDistanceEncoder.setPIDSourceType(PIDSourceType.kDisplacement);
        driveSystemFrontRightDistanceEncoder = new Encoder(22, 23, false, EncodingType.k4X);
        LiveWindow.addSensor("DriveSystem", "FrontRightDistanceEncoder", driveSystemFrontRightDistanceEncoder);
        driveSystemFrontRightDistanceEncoder.setDistancePerPulse(1.0);
        driveSystemFrontRightDistanceEncoder.setPIDSourceType(PIDSourceType.kDisplacement);
