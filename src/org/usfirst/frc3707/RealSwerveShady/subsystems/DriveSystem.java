...
public class DriveSystem extends Subsystem {
    ...
    public final ADXRS450_Gyro gyro = RobotMap.gyro;
      ...
      //COMP ROBOT
    //SwerveWheel frontLeftWheel = new SwerveWheel(frontLeftTwist, frontLeftDrive, 354); //340
    //SwerveWheel frontRightWheel = new SwerveWheel(frontRightTwist, frontRightDrive, 197); //341
    //SwerveWheel backLeftWheel = new SwerveWheel(backLeftTwist, backLeftDrive, 302); //210
   // SwerveWheel backRightWheel = new SwerveWheel(backRightTwist, backRightDrive, 102); //12
    ...
    public void readDistance ( ) {
    	double rightDistanceFt = (frontRightDistanceEncoder.getDistance()/133)*4*Math.PI;
    	double leftDistanceFt = (frontLeftDistanceEncoder.getDistance()/133)*4*Math.PI;
    	SmartDashboard.putNumber("leftFrontDistance", leftDistanceFt);
    	SmartDashboard.putNumber("rightFrontDistance", rightDistanceFt);
    }
    
    public double getLeftDistance() {
    	return (frontLeftDistanceEncoder.getDistance()/133)*4*Math.PI;
    }
    
    public double getRightDistance() {
    	return (frontRightDistanceEncoder.getDistance()/133)*4*Math.PI;
    }
...
//    }
    ...
    public void periodic() {
    	...
    	// Convert Encoder Values to Feet
    	double rightDistanceFt = (frontRightDistanceEncoder.getDistance()/133)*4*Math.PI;
    	double leftDistanceFt = (frontLeftDistanceEncoder.getDistance()/133)*4*Math.PI;
