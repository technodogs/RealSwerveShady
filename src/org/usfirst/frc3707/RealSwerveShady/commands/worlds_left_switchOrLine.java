 ...
 *
 */
public class worlds_left_switchOrLine extends ConditionalCommand {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public worlds_left_switchOrLine() {
      super(new worlds_left_leftSwitchSide(), new auto_path_crossLine());
