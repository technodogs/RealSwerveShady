 ...
 *
 */
public class auto_move_toSwitch_left extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public auto_move_toSwitch_left() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    	...
    	addSequential(new auto_drive_timer(0.5, 270.0, 0.3));
    	addSequential(new auto_drive_timer(1.5, 270.0, 0.75));
    	addSequential(new auto_drive_timer(0.2, 270.0, 0.3));
