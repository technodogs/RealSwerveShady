 ...
 *
 */
public class auto_path_center_chooseSwitchScale extends ConditionalCommand {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public auto_path_center_chooseSwitchScale() {
      super(new auto_path_center_leftSwitch_scale(), new auto_path_center_rightSwitch_scale());
