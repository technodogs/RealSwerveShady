 ...
 *
 */
public class auto_path_left_rightScale extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public auto_path_left_rightScale() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=COMMAND_DECLARATIONS
    	...
    	addSequential(new auto_drive_rotateToAngle(350), 0.4);
    	...
    	addSequential(new auto_drive_rotateToAngle(220), 1.5);
    	
    	addParallel(new auto_claw_suckTimed(1.9));
    	addSequential(new auto_drive_timer(1.9, 0, 0.45));
    	addSequential(new auto_drive_timer(1, 0, -0.4));
    	
    	addParallel(new auto_lift_moveToHigh(),3);
    	addSequential(new auto_drive_rotateToAngle(345), 1.5);
...
//    	addSequential(new auto_pathfinder("leftToRightScale"));
//    	
//    	addSequential(new auto_drive_rotateToAngle(350), 0.2);
//    
//    	addParallel(new auto_drive_timer(2, 0, 0.3));
//    	addSequential(new auto_lift_moveToHigh(),2);
//    	addSequential(new auto_claw_spitTimed(0.6));
...
//    	addParallel(new auto_lift_moveToLow());
//    	//addSequential(new auto_drive_rotateToAngle(220), 1.5);
//    	addSequential(new auto_drive_timer(1.5, 270, -0.4), 0.5);
